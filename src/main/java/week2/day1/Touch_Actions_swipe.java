...
public class Touch_Actions_swipe {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		// Let's do some actions on mobile
		TouchAction<?> action1 = new TouchAction<>(driver).press(PointOption.point(startXleft, StartYleft))
				.waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
				.moveTo(PointOption.point(endXleft, endYleft)).release().perform();
